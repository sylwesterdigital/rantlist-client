...
const {revisionAtLeast}=require('./assert_compatible_release');
...
assert(revisionAtLeast(meta.sourceRevision,388));
...
assert(web.includes("case 'stage.activity.presence':"));
assert(web.includes("case 'stage.activity.presence.reject':"));
assert(web.includes("case 'stage.world.edit':"));
console.log('Native Stage frame and authoring activity transport regression passed (self-contained client package).');
